...
class Project(Base):
    ...
    # Walkability (POI distances, counts 800 m, sub-scores; separate from micro_location)
    ...
    count_supermarket_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_drugstore_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_pharmacy_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_atm_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_post_office_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_restaurant_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_cafe_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_park_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_fitness_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_playground_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_kindergarten_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_primary_school_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
    count_pediatrician_800m: Mapped[int | None] = mapped_column(Integer, nullable=True)
